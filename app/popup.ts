...
import {createHorizontalBarChart} from "./chart";
...
// ポップアップ設定の方法ー２
// 変動率の計算
function calChange(year_val :number, last_year_val :number){
...
// n年間の平均変動率
function geometricMean(arr :number[] , n :number){
    var sum = 0;
    for (var i = 0; i < n; i++)
...
const chikakojiPopupTemplate = new PopupTemplate({
...
function landpriceChange(feature : esri.Feature) {
